...
// Selector used by observer to detect post containers; must match first item in DESCRIPTION_SELECTORS
export const DESCRIPTION_SELECTOR = '[data-testid="expandable-text-box"]';
